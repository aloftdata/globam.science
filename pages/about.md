...
![species](/assets/img/species_compressed.jpg) _We aim to use weather radars to monitor the migrations of aerial migrants such as a) birds (Barth Bailey/Unsplash.com) and b) insects (aaabbbccc/Shutterstock.com)._
...
![biomass flows](/assets/img/biomass_flow_fig_cropped.png) _Average intensities of bird migration, inferred from weather radar data, across a) Europe over 3 weeks in autumn 2016 (from [Nilsson et al. 2019](https://doi.org/10.1111/ecog.04003)), and b) during spring across the US between 1995-2017 (from [Horton et al. 2019](https://doi.org/10.1002/fee.2029))._

## Forecast

![simulation](/assets/img/Cuckoo_mean_sim_website.gif) _Simulated spring migrations of Afro-Palearctic migratory birds, from preliminary behaviour-based models developed within GloBAM._

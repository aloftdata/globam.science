...
{: .clearfix}
![picture](/assets/images/team-felix-liechti.png){: style="height: 100px; width: 100px; border-radius: 100px; border: 3px solid #e9ecef;" .mr-3 .float-start}
...
{: .clearfix}
![picture](/assets/images/team-judy-shamoun-baranes.jpg){: style="height: 100px; width: 100px; border-radius: 100px; border: 3px solid #e9ecef;" .mr-3 .float-start}
...
{: .clearfix}
![picture](/assets/images/team-silke-bauer.jpg){: style="height: 100px; width: 100px; border-radius: 100px; border: 3px solid #e9ecef;" .mr-3 .float-start}

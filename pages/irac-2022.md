...
For more information on Davos, how to get there, accommodation, the environment and things to do in and around Davos, please see <https://www.worldbiodiversityforum.org/en/davos>.
...
Please contact us with any question that you may have regarding the conference, incl. suggestions for additional (informal) events that you might want to organize (e.g. round-table discussions or similar) via <globam@vogelwarte.ch>.
